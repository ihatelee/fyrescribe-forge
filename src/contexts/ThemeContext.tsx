...
const THEME_VARS: Record<ThemeName, Record<string, string>> = {
  ...
  outrun: {
    ...
    "--border": "147 100% 33% / 0.20",
    "--input": "147 100% 33% / 0.15",
    "--ring": "168 100% 50%",
    "--bg-deepest": "0 0% 0%",
    "--bg-base": "0 0% 2%",
    "--bg-raised": "0 0% 5%",
    ...
    "--sidebar-border": "147 100% 33% / 0.20",
