...
const THEME_VARS: Record<ThemeName, Record<string, string>> = {
  ...
  futureworld: {
    ...
    "--text-dimmed": "0 0% 30%",
    "--gold": "168 100% 50%",
    "--gold-bright": "168 100% 60%",
    "--gold-glow": "168 100% 50% / 0.08",
    "--border-subtle": "168 100% 50% / 0.08",
    "--sidebar-background": "0 0% 2%",
    "--sidebar-foreground": "0 0% 55%",
    "--sidebar-primary": "168 100% 50%",
    "--sidebar-primary-foreground": "0 0% 0%",
    "--sidebar-accent": "168 100% 50% / 0.08",
    "--sidebar-accent-foreground": "168 100% 60%",
  ...
  daylight: {
    ...
    "--sidebar-primary-foreground": "40 25% 96%",
  ...
  enchanted: {
    ...
    "--primary": "160 100% 39%",
    "--primary-foreground": "180 30% 4%",
    "--secondary": "180 22% 9%",
    "--secondary-foreground": "170 30% 88%",
    "--muted": "180 18% 12%",
    "--muted-foreground": "180 12% 45%",
    "--accent": "160 100% 39%",
    "--accent-foreground": "180 30% 4%",
    "--destructive": "0 62% 50%",
    "--destructive-foreground": "170 30% 88%",
    "--border": "170 20% 65% / 0.08",
    "--input": "170 20% 65% / 0.12",
    "--ring": "160 100% 39%",
    "--bg-deepest": "180 30% 3%",
    "--bg-base": "180 28% 4%",
    "--bg-raised": "180 22% 8%",
    ...
    "--text-dimmed": "180 18% 26%",
    "--gold": "160 100% 39%",
    "--gold-bright": "160 100% 48%",
    "--gold-glow": "160 100% 39% / 0.08",
    "--border-subtle": "170 20% 65% / 0.08",
    "--sidebar-background": "180 28% 4%",
    "--sidebar-foreground": "180 12% 45%",
    "--sidebar-primary": "160 100% 39%",
    "--sidebar-primary-foreground": "180 30% 4%",
    "--sidebar-accent": "160 100% 39% / 0.08",
    "--sidebar-accent-foreground": "160 100% 48%",
    "--sidebar-border": "170 20% 65% / 0.08",
